    ...
    int analog2SeqNumber()
      {
        ...
        if (0.25<anaValue && anaValue<0.65){
            Serial.print("Selected sequence = 2\n");
            return 2;
        }
     if (0.65<anaValue && anaValue<0.95){
...
void sequence1_4(){                             // sequence 1 in 4th octave
...
void sequence1_5(){                             // sequence 1 in 5th octave
...
void sequence2_4(){                             // sequence 1 in 5th octave
      wavetable.playFrequency(97.9988589954);//G
      delay(1710);
      wavetable.stop();
...
void sequence2_5(){                             // sequence 1 in 5th octave
      wavetable.playFrequency(195.9977179909);//G
      delay(1710);
      wavetable.stop();
