...
AudioConnection          patchCord25(mixer3, freeverb1);
AudioConnection          patchCord26(freeverb1, 0, i2s1, 0);
AudioConnection          patchCord27(freeverb1, 0, i2s1, 1);
...
// Amps
  amp1.gain(0.5);
  amp2.gain(0.5*0.5);
  amp3.gain(0.5*0.5*0.5);
  amp4.gain(0.5*0.5*0.5*0.5);
  amp5.gain(0.5*0.5*0.5*0.5*0.5);
  amp6.gain(0.5*0.5*0.5*0.5*0.5*0.5);
  amp7.gain(0.5*0.5*0.5*0.5*0.5*0.5*0.5);
  amp8.gain(0.5*0.5*0.5*0.5*0.5*0.5*0.5*0.5);
  amp9.gain(0.5*0.5*0.5*0.5*0.5*0.5*0.5*0.5*0.5);
